...
public class RandomizerUI extends JFrame {
	...
	public static String location = "baserom.gbc";
	...
	public static void main(String[] args) {
		...
		RandomizerUI self = new RandomizerUI("TCG randomizer | Aroymart");
		self.pack();
	...
	public RandomizerUI(String title){
	...
	public void saveRom(){
		File checkFile = new File(fileLocation.getText());
		if(!checkFile.exists()){
			JOptionPane.showMessageDialog(null, "Error: no base rom found.");
			return;
		}
		RomRandomizer rando = new RomRandomizer(fileLocation.getText());
		...
		fc.showOpenDialog(RandomizerUI.this);
	...
	public void loadRom(){
		...
		try{
			...
			fileLocation.setText("No File Selected.");
		}
